...
import Evergreen.V1.Gen.Params.Profile.UserId_
...
type Model
    ...
    | Profile__UserId_ Evergreen.V1.Gen.Params.Profile.UserId_.Params Evergreen.V1.Pages.Profile.UserId_.Model
