...
import Evergreen.V3.Gen.Params.Profile.UserId_
...
type Model
    ...
    | Profile__UserId_ Evergreen.V3.Gen.Params.Profile.UserId_.Params Evergreen.V3.Pages.Profile.UserId_.Model
